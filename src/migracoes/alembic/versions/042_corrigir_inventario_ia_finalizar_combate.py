"""Corrigir função finalizar_combate para usar estrutura correta da Inventario_IA
...
def upgrade():
    # Corrigir a função finalizar_combate para usar a estrutura correta da Inventario_IA
    op.execute("""
