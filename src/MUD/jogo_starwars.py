class JogoStarWars:
    ...
    def loop_jogo(self):
        while True:
            ...
            print("6. combate - Iniciar combate")
            print("7. inventario - Abrir seu inventário")
            ...
            elif comando == "6" or comando == "combate":
                self.menu_combate()
            elif comando == "7" or comando == "inventario":
                self.menu_inventario()
                
            elif comando == "8" or comando == "sair":
                self.jogador_atual = None
